    ...
    : QWidget(parent)
{
    ...
    kcfg_FgColor->setObjectName(QLatin1StringView("kcfg_FgColor"));
    ...
    kcfg_BgColor->setObjectName(QLatin1StringView("kcfg_BgColor"));
    ...
    kcfg_ShowInTaskbar->setObjectName(QLatin1StringView("kcfg_ShowInTaskbar"));
    ...
    if (defaults) {
        ...
        kcfg_Width->setObjectName(QLatin1StringView("kcfg_Width"));
        ...
        kcfg_Height->setObjectName(QLatin1StringView("kcfg_Height"));
