    ...
    : QWidget(parent)
{
    ...
    kcfg_TabSize->setObjectName(QLatin1StringView("kcfg_TabSize"));
    ...
    kcfg_AutoIndent->setObjectName(QLatin1StringView("kcfg_AutoIndent"));
    ...
    kcfg_Font->setObjectName(QLatin1StringView("kcfg_Font"));
    ...
    kcfg_TitleFont->setObjectName(QLatin1StringView("kcfg_TitleFont"));
